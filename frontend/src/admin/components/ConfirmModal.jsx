  ...
  return (
    <div className="fixed inset-0 bg-black/40 flex items-center justify-center z-50 px-4">
      <div className="bg-dark-card border border-dark-border rounded-sm p-6 w-full max-w-sm shadow-xl">
        <h3 className="font-light text-lg mb-2" style={{ fontFamily: 'Cormorant Garamond, Georgia, serif', color: '#2A2420' }}>
          Confirmar acción
        </h3>
        <p className="text-sm mb-6" style={{ color: '#6A6460' }}>{message}</p>
